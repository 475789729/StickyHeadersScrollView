 ...
 */
public class StickyHeadersNestedScrollView extends NestedScrollView{
    ...
    public StickyHeadersNestedScrollView(Context context) {
        this(context, null);
    }

    public StickyHeadersNestedScrollView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public StickyHeadersNestedScrollView(Context context, AttributeSet attrs, int defStyle) {
